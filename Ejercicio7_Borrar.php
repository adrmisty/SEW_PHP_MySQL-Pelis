...
<head>
    ...
    <meta name="description" content="Gestión de una base de datos con MySQL (temática libre: CINE) --- BORRAR " />
...
<body>
    ...
    <form method="post" action="#" >
        <fieldset>
        <h3>Borrar películas</h3>
                    <label for="borrarPeli">Introduzca el nombre de la película a eliminar: </label>  
                    <select id="borrarPeli" name="borrarPeli">
                    <option value="---">---</option>
        ...
        <section>
        <h4>Resultado del borrado: </h4>
            <?php $_SESSION['bdcine']->getMensajeBorrarDatos()?>
        </section>
