...
<body>
    ...
    <form method="post" action="#" >
        <fieldset>
            <h3>Mostrar las películas dirigidas por...</h3>

            <label for="buscarPorDirector">* Nombre del director: </label>  
                <select id="buscarPorDirector" name="buscarPorDirector">
                    <option value="---">---</option>
                    <?php $_SESSION['bdcine']->getOpcionDirectores()?>
                </select>

                <input type="submit" name="buscarDirector" value="Buscar" />

        </fieldset>

        <section>
            <h4>Resultado de la búsqueda: </h4>
            <?php $_SESSION['bdcine']->getMensajeBuscarDirector()?>
        </section>
    </form>
